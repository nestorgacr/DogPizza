...
const access_token = "EAAFIPLUnmjYBAFKaMuiUYfNsEBRr1hnygvZA3wZAPVhFras9MYYSe7sIUGlZA3CWPDPC6vvAdEzHcdX6js5DfLE4vewEC8qfJ6hdBYMlofu5r4ZC4jIZC0Kfkz9L3qNkmNa6zUNunIQvfZAiRAnSPvGxjjATRCBqfvkdTvavJftwZDZD";
...
app.get('/webhook', function(req, response) {
    if (req.query['hub.verify_token'] == 'dogpizza_token') {
        response.send(req.query['hub.challenge']);
    } else {
        response.send('Dog Pizza no tienes permissos');
    }
});
